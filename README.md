...
|---|---|---|
| A — Registry Diff | Phát hiện thiết bị KNX/Matter mới qua registry chứng nhận, không dùng LLM | Đang build — webapp riêng (`track-a/webapp/`), không dùng n8n. Xem [track-a/README.md](track-a/README.md) |
